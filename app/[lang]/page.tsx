...
export default async function Home({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return <main>
    ...
    <Teaser title="OUR STORY" copy={'Built on moments, not occasions.\nA drink that brings people together.'} link={`/${lang}/our-story`} label="Where it began" image="IMG_4703.jpg" />
    ...
    <section className="section"><div className="container"><h2 className="display section-title animate-headline">WHERE WE BLEND IN</h2><p className="copy">From quiet nights to crowded tables.\nDifferent settings, same warmth.\nSomehow, we always seem to fit right in.</p><div className="grid-two" style={{ marginTop: 42 }}><ImageSlot name="IMG_2355.jpg" alt="IMG_2355.jpg" ratio="3/4" /><ImageSlot name="IMG_1871.jpg" alt="IMG_1871.jpg" ratio="3/4" /></div></div></section>
